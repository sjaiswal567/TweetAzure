...
namespace TweetApp.Api.Controllers
{
    ...
    public class TweetsController : ControllerBase
    {
        ...
        private readonly IProducerMessage<string> _producermessage;

        public TweetsController(IServices services, IProducerMessage<string> producermessage)
        {
            _services = services;
        ...
        public async Task<object> PostTweet([FromRoute] string username, [FromBody] TweetCreateDto tweetDto)
        {
            ...
            await _producermessage.ProduceAsync(_response.DisplayMessage);
